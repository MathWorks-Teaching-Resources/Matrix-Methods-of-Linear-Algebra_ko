classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Matrix-Methods-of-Linear-Algebra";
    end
...
%{
    ...
    4. Change image in app.Image by the cover image you would like for your
       module. This image should be located in rootFolder/ImagesMatr
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = '선형대수학의 행렬 방법 코스에 오신 것을 환영합니다';
            ...
            app.Image.Position = [28 141 222 185];
            app.Image.ImageSource = 'MatrixMethods.png';
            ...
            app.ReviewText.Text = '여러분의 경험 개선에 도움을 드리고자 하오니 몇 가지 질문에 답변을 부탁드립니다.';
            ...
            app.ReviewTitle.Text = '선형대수학의 행렬 방법 코스에 오신 것을 환영합니다';
            ...
            app.Q1.Text = '당신을 가장 잘 설명하는 것은 무엇입니까?';
